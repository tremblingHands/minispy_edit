...
--*/
{
	...
	//omni
	//fprintf(File, "\t%d", RecordData->CallbackMajorId);
	/*
	if (RecordData->CallbackMajorId != 4) {
		fprintf(File, "\t0x%p", RecordData->Arg5);
	}
	else {
		fprintf(File, "\t_omni_%s", (char *)RecordData->Arg5);
	}
	*/
    fprintf( File, "\t0x%p", RecordData->Arg5 );
	//fprintf(File, "\t_omni_%s", (char *)RecordData->Arg5);
...
--*/
{
	...
	/*
	if (RecordData->CallbackMajorId == 4) {
		printf("\t_omni_%s", (char *)RecordData->Arg5);
	}
	*/
